...
mongoose.connect('mongodb://localhost:27017/TDB-2018036', {useNewUrlParser:true, useUnifiedTopology: true})
    .then(()=>{
        ...
        app.listen(port, ()=>{
            ...
            console.log('-Colocar ID de cualquier tweet como parámetro al comando VIEW_TWEETS para ver detalles');
        });
    }).catch(err=>{
